 ...
 */
  ...
  <body class="gradient leading-relaxed tracking-wide flex flex-col">
    ...
    <nav id="header" class="w-full z-30 top-0 text-white py-1 lg:py-6">
      <div
        id="navitems" class="w-full container mx-auto flex flex-wrap items-center justify-between m-0 px-3 py-0"
      >
        <div class="pl-4 flex items-center">
          <a
            id="logo" class=" no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
            href="#"
          >
            <svg
        ...
        >
          <ul id="navcontent" class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <a
                id="nav-link"
          ...
          <button
            id="navAction"
            class="mx-auto lg:mx-0 hover:underline text-gray-800 font-extrabold rounded mt-4 lg:mt-0 py-4 px-8 shadow opacity-90"
          >
            Action
          </button>
        </div>
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="text-white uppercase tracking-loose w-full">What business are you?</p>
    ...
    <section class="bg-white border-b py-12 m-0">
      <div
        id="fade-in" class="container mx-auto flex flex-wrap items-center justify-between pb-12"
      >
        <h2
    ...
    <section class="bg-gray-100 border-b py-8">
      <div id="from-left" class="container max-w-5xl mx-auto m-8">
        <h2
        ...
        >
          ...
          >
            <div class="flex-1 rounded-t rounded-b-none overflow-hidden">
              <div class="w-full text-white p-8 text-3xl font-bold text-center">Basic</div>
              <ul  class="w-full text-center text-base font-bold">
                <li id="offer" class="text-white py-4">Thing</li>
                <li id="offer" class="text-white py-4">Thing</li>
                <li id="offer" class="text-white py-4">Thing</li>
                <li id="offer" class="text-white py-4">Thing</li>
              </ul>
            ...
            >
              <div class="w-full pt-6 text-white text-4xl font-bold text-center">
    ...
    <script>
      ...
      var navbar = document.querySelector("#header" , "#logo","#navcontent");
